...
use Higurashi\Service\NamesInserter;
...
class InsertNames extends Command
{
    protected function configure(): void
    {
        $this
            ->setName('higurashi:insert-names')
            ->setDescription('Inserts names to the given chapter.')
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $directory = sprintf('%s/insert-names/%s', TEMP_DIR, $chapter);

        $updater = new NamesInserter($chapter, $directory, $connection);
