...
class Colors extends Command
{
    ...
    {
        $this
            ->setName('higurashi:colors')
            ->setDescription('Updates character colors in specified chapter.')
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $directory = sprintf('%s/colors/%s', TEMP_DIR, $chapter);

        $updater = new ColorsUpdater($chapter, $directory, $connection);
