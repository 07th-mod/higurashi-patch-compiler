...
use Higurashi\Service\VolumeUpdater;
...
class Volume extends Command
{
    ...
    {
        $this
            ->setName('higurashi:volume')
            ->setDescription('Adjusts audio volume.')
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $directory = sprintf('%s/volume/%s', TEMP_DIR, $chapter);

        $updater = new VolumeUpdater($chapter, $directory);
