...
class RemoveDisplayWindow extends Command
{
    ...
    {
        $this
            ->setName('higurashi:remove-display-window')
            ->setDescription('Removes DisplayWindow call after ModDrawCharacter.')
    ...
    {
        if (Strings::contains($line, 'DisplayWindow();') && Strings::contains($lines->get(-1), 'ModDrawCharacter')) {
            return '';
        }
