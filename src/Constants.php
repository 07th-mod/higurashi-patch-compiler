...
class Constants
{
    ...
    public const PATCHES = [
        'onikakushi' => [
            ...
            'onikakushi_steam' => 'https://github.com/jwgrlrrajn/higurashi-steam-sprite-mods/releases/download/1.1.0/onikakushi-steam-sprites.zip',
        ],
        'watanagashi' => [
            ...
            'onikakushi_steam' => 'https://github.com/jwgrlrrajn/higurashi-steam-sprite-mods/releases/download/1.1.0/onikakushi-steam-sprites.zip',
            'watanagashi_steam' => 'https://github.com/jwgrlrrajn/higurashi-steam-sprite-mods/releases/download/1.1.0/watanagashi-steam-sprites.zip',
        ],
        'tatarigoroshi' => [
            ...
            'tatarigoroshi_steam' => 'https://github.com/jwgrlrrajn/higurashi-steam-sprite-mods/releases/download/1.1.0/tatarigoroshi-steam-sprites.zip',
        ],
        'himatsubushi' => [
            ...
            'himatsubushi_steam' => 'https://github.com/jwgrlrrajn/higurashi-steam-sprite-mods/releases/download/1.1.0/himatsubushi-steam-sprites.zip',
        ],
    ];
